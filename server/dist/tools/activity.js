...
export function registerActivityTools(server) {
    server.tool('cortex_activity_log', 'Get activity log — structured audit trail of all important operations', {
    ...
    server.tool('cortex_log_activity', 'Manually log an activity entry — call after important operations', {
